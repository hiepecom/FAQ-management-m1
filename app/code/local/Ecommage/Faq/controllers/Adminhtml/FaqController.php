...
class Ecommage_Faq_Adminhtml_FaqController extends Mage_Adminhtml_Controller_action
{

    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('faq/faq_management')
    ...
    public function editAction()
    {
        ...
        if ($model->getId() || $id == 0) {
            ...
            $this->_addContent($layout->createBlock('faq/adminhtml_faq_edit'))
                ->_addLeft($layout->createBlock('faq/adminhtml_faq_edit_tabs'));
